...
describe Decidim::Nbs::ContentBlocks::HighlightedPostsCell, type: :cell do
  subject { cell("decidim/nbs/content_blocks/highlighted_posts", content_block).call }

  controller Decidim::Nbs::PostsController

  let(:organization) { create(:organization) }
  let(:participatory_space) { create(:participatory_process, organization:) }
  let(:component) { create(:component, participatory_space:, manifest_name: "nbs") }

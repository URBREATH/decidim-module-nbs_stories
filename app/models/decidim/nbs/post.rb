...
module Decidim
  module Nbs
    # The data store for a Blog in the Decidim::Nbs component. It stores a
    # title, description and any other useful information to render a blog.
    class Post < Nbs::ApplicationRecord
      ...
      class << self
        ...
        def log_presenter_class_for(_log)
          Decidim::Nbs::AdminLog::PostPresenter
        end
      end
